              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link href={`/services#${service.slug}`}>
                    <span className="inline-block text-primary font-medium hover:text-primary/90 transition group cursor-pointer">
                      Learn more <i className="fas fa-arrow-right ml-1 text-primary"></i>
                    </span>
                  </Link>
                </div>
              </div>
